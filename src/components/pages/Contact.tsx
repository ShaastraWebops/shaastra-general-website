...
const Contact = () => {
    return(
        <CustomBox>
            <Flex width="100vw" padding={["20vw 0 0 0","4vw 0 0 0"]} justifyContent={"space-between"} flexDirection={["column", "row"]} alignItems={"center"}>
                <Flex paddingLeft={"2vw"} flexDirection={"column"} width="50%" alignItems={"center"}>
                    ...
                    <Flex width="50vw" paddingBottom={"6vh"} flexDirection={"column"} alignItems={"center"}>
                        ...
                        <Flex width={["90vw","50vw"]} justifyContent={"space-evenly"}>
                            ...
                            <Flex flexDirection={"column"}>
                                <Text fontWeight={"bold"} fontSize={["4vw","1.5vw"]}>Vyshnavi</Text>
                                <Text fontSize={["4vw","1.5vw"]}>  <a href={"http://wa.me/+918897091122"} target="_blank"><p>+91 88970 91122</p></a></Text>
                            </Flex>
                        </Flex>
                    </Flex>
                    ...
                    <Flex width={["90vw","50vw"]} paddingBottom={"6vh"} alignItems={"center"} justifyContent={"space-evenly"}>
                        <Flex flexDirection={"column"}>
                            ...
                            <Flex flexDirection={"column"}>
                                <Text fontWeight={"bold"} fontSize={["4w","1.5vw"]}>Aditya</Text>
                                <Text fontSize={["4vw","1.5vw"]}><a href={"http://wa.me/+918178180545"} target="_blank"><p>+91 81781 80545</p></a></Text>
                            </Flex>
                        </Flex>
                        <Flex flexDirection={"column"}>
