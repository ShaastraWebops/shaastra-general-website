                ...
                <div className="main-boxx">
                    <div className="card__collection clear-fix mitesh">
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://www.kla-tencor.com/company"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/klacorp/"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/KLAcorp/"><img alt="" src={facebook} id="www3"></img></a></p>
                            </span>
                            <span className="cards--three__rect-2">
                                <span className="shadow-2"></span>
                            </span>
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://www.mahindra.com/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/mahindragroup/?originalSubdomain=in"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/MahindraRise/"><img alt="" src={facebook} id="www3"></img></a></p>
                            </span>
                            <span className="cards--three__rect-2">
                                <span className="shadow-2"></span>
                            </span>
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://www.salesforce.com/in/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/salesforce/"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/salesforce/"><img alt="" src={facebook} id="www3"></img></a></p>
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://foxmula.com/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/foxmula-official/?originalSubdomain=in"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/foxmulaOfficial/"><img alt="" src={facebook} id="www3"></img></a></p>
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://innovaccer.com/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/innovaccer/?originalSubdomain=in"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/InnovAccer/"><img alt="" src={facebook} id="www3"></img></a></p>
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://www.larsentoubro.com/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/larsen-&-toubro-limited/?originalSubdomain=in"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/LT-Construction-364964870240516/"><img alt="" src={facebook} id="www3"></img></a></p>
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://www.mtxb2b.com/s/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/mtx-group/?originalSubdomain=in"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/mtxb2b/"><img alt="" src={facebook} id="www3"></img></a></p>
                        ...
                        <div className="cards cards--three" id="photo">
                            ...
                            <span className="cards--three__rect-1">
                                <span className="shadow-1"></span>
                                <p className="text"><a href="https://www.wellsfargo.com/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/wellsfargo/"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/wellsfargo/"><img alt="" src={facebook} id="www3"></img></a></p>
                            </span>
                            <span className="cards--three__rect-2">
                                <span className="shadow-2"></span>
                            </span>
                        ...
                        <div className="card" id="photo">
                            ...
                            <div className="card-front">
                            <img src={innovaccer} className="img-responsive" id="inno" alt="" />
                            </div>
                            <div className="card-back">
                            <p className="text"><a href="https://innovaccer.com/"><img src={www} id="www1" alt=""></img></a><a href="https://www.linkedin.com/company/innovaccer/?originalSubdomain=in"><img alt="" src={linkedin} id="www2"></img></a><a href="https://www.facebook.com/InnovAccer/"><img alt="" src={facebook} id="www3"></img></a></p>
