    ...
    style={{
      ...
      options={{ 
        ...
        <CustomBox >
            ...
            <Center data-aos="zoom-in">
                <Image src="/shows_1.png" borderRadius="8" width="80%"   style={{
               zIndex:1
           }}/>
            </Center>
            <Center margin="20px 0">
            ...
            <Grid templateColumns={`repeat(${cols || 2}, 1fr)`} justifyItems="center" padding="0 10px" rowGap="5">
                <GridItem>
                    <Center>
                        <Image borderRadius="8" data-aos="zoom-in" width="600px" src="/shows_2.png" height="500px"   style={{
               zIndex:1
           }} />
                    </Center>
                </GridItem>
                <GridItem>
                    <Center>
                        <Image borderRadius="8" data-aos="zoom-in" width="600px" src="/shows_3.png" height="500px"   style={{
               zIndex:1
           }}/>
                    </Center>
                </GridItem>
