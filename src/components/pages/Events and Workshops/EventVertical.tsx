                ...
                >
                    ...
                    {name === "workshops" ? (
                        <Flex flexWrap={'wrap'} width={'100%'} justifyContent={'space-around'}>
                            ...
                            <CardForWorkShop title="PM 101, Consult 101" WS1="Product Management 101" WS2="Consult 101" WS3="Parallel Processing and Real-time OS" Price1="500" Price2="500" Price3="350" ActualPrice="1350" DiscountedPrice="1150" ComboName="Electronic Combo" />
                        </Flex>
                    ) : (
                        <></>
                    )}
