...
const WorkshopRecordings = () => {
  ...
  return(
    <Flex width={'100%'} flexDirection={['column','column','row','row']} justifyContent={'center'}>
        <Flex flexDirection={'column'} width={'100%'} justifyContent={'center'} alignItems={'center'}  borderRadius={'10px'}>
        <Heading m={2} p={2}></Heading>
        <Text paddingTop={'20px'} fontSize={'30px'} fontWeight={800} paddingBottom={'0px'}>Get a Workshop Recording</Text>
        <Text paddingTop={'10px'} fontSize={'25px'} fontWeight={600} paddingBottom={'0px'}>At Price &#8377;500</Text>
       <Text paddingTop={'0px'} fontSize={'20px'} fontWeight={600} paddingBottom={'20px'}>Select a workshop</Text>
        
        <Flex width={'90%'} justifyContent={'center'}>
            <Select placeholder='Select a Workshop' value={w} onChange={(e) => setW(e.target.value)} marginBottom={'20px'}>
    ...
    <Flex flexDirection={'column'} width={'100%'} justifyContent={'center'} alignItems={'center'}  borderRadius={'10px'}>
        <Heading m={2} p={2}></Heading>
        <Text paddingTop={'20px'} fontSize={'30px'} fontWeight={800} paddingBottom={'0px'}>Get 3 Workshop Recordings</Text>
        <Text paddingTop={'10px'} fontSize={'25px'} fontWeight={600} paddingBottom={'0px'}>At Only Discounted Price &#8377;999</Text>
        <Text paddingTop={'0px'} fontSize={'20px'} fontWeight={600} paddingBottom={'20px'} textDecorationLine={'line-through'}>&#8377;1500</Text>
        <Text paddingTop={'0px'} fontSize={'20px'} fontWeight={600} paddingBottom={'20px'}>Select three workshops</Text>
        
        <Flex width={'90%'} justifyContent={'center'}>
            <Select placeholder='Select 1st Workshop' value={w1} onChange={(e) => setW1(e.target.value)} marginBottom={'20px'}>
            <option value='ckxf0bz5k003cdbp7edik9klx'>Inverse Kinematics using ROS Moveit</option>
                <option value='ckxepglch00122bp7gjk52d0i'>Sustainability using Machine Learning and Data Science</option>
                <option value='ckxf366390043cup7872ocv1y'>Circuit simulation and PCB design</option>
                <option value='ckxljoxqa00639bp7gu9o1sz9'>Grant Writing Workshop</option>
        ...
        <Flex width={'90%'} justifyContent={'center'}>
            <Select placeholder='Select 2nd Workshop' value={w2} onChange={(e)=> setW2(e.target.value)} marginBottom={'20px'}>
            <option value='ckxf0bz5k003cdbp7edik9klx'>Inverse Kinematics using ROS Moveit</option>
                <option value='ckxepglch00122bp7gjk52d0i'>Sustainability using Machine Learning and Data Science</option>
                <option value='ckxf366390043cup7872ocv1y'>Circuit simulation and PCB design</option>
                <option value='ckxljoxqa00639bp7gu9o1sz9'>Grant Writing Workshop</option>
        ...
        <Flex width={'90%'} justifyContent={'center'}>
            <Select placeholder='Select 3rd Workshop' value={w3} onChange={(e)=> setW3(e.target.value)} marginBottom={'20px'}>
            <option value='ckxf0bz5k003cdbp7edik9klx'>Inverse Kinematics using ROS Moveit</option>
                <option value='ckxepglch00122bp7gjk52d0i'>Sustainability using Machine Learning and Data Science</option>
                <option value='ckxf366390043cup7872ocv1y'>Circuit simulation and PCB design</option>
                <option value='ckxljoxqa00639bp7gu9o1sz9'>Grant Writing Workshop</option>
